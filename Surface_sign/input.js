...
v[5] = v[5].reverse()
t[5] = v[5]
v[6] = ['REF_polar','REF_polar+mpef']
t[6] = ['REF_polar','REF_polar+mpef']
v[7] = ['ALL'] ;
t[7] = v[7] ;
...
pdir ='Surface/'
ext='1.png'
help = 'cca runs with cy43h21 MNWC settings and observations. <br> REF: cy43h21 with MNWC obs and MEPS2_preop FG, + MSGcloudingest <br> polar: REF + AMVs only from polar orbiting METOP, <br> polar+mpef: REF + polar and geostationary MPEF AMVs from MSG.'; hide_help = false ;
do_send = true ;
